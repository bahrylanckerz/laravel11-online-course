                    ...
                    <div class="item-card flex flex-row justify-between items-center">
                        ...
                        <div>
                            ...
                            @if ($transaction->is_paid)
                                <span class="py-1 px-2 bg-green-500 text-white font-bold text-sm rounded mt-2">ACTIVE</span>
                            @else
                                <span class="py-1 px-2 bg-orange-500 text-white font-bold text-sm rounded mt-2">PENDING</span>
                            @endif
                        </div>
                        ...
                        <div class="hidden md:flex flex-row items-center gap-x-3">
                            <a href="{{ route('admin.subscribe_transactions.show', $transaction) }}" class="font-bold py-2 px-4 bg-indigo-700 hover:bg-indigo-800 text-white rounded-md">
                                View Details
                            </a>
                        </div>
                    </div>
                @empty
                    <p>Data Subscription Not Available</p>
                @endforelse
            </div>
        </div>
    </div>
