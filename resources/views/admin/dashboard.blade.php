            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                @role('teacher')
                    <div class="item-card flex flex-col gap-y-10 md:flex-row justify-between items-center">
                        ...
                        <a href="{{route('admin.courses.create')}}" class="w-fit font-bold py-2 px-6 bg-indigo-700 text-white rounded-md">
                            Create New Course
                        </a>
                    </div>
                @endrole
                @role('student')
                    ...
                    <a href="{{route('home.index')}}" class="w-fit font-bold py-2 px-6 bg-indigo-700 text-white rounded-md">
                        Explore Catalog
                    </a>
                @endrole
            </div>
