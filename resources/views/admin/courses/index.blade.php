<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-row justify-between items-center">
            ...
            <a href="{{ route('admin.courses.create') }}" class="font-bold py-2 px-4 bg-indigo-700 hover:bg-indigo-800 text-white rounded-md">
                Add New
            </a>
        </div>
    </x-slot>
                ...
                @forelse ($courses as $course)
                    <div class="item-card flex flex-col md:flex-row gap-y-10 justify-between md:items-center">
                        ...
                        <div class="hidden md:flex flex-col">
                            ...
                            <h3 class="text-indigo-950 text-xl font-bold">{{ $course->videos->count() }}</h3>
                        </div>
                        <div class="hidden md:flex flex-col">
                        ...
                        <div class="hidden md:flex flex-row items-center gap-x-3">
                            <a href="{{ route('admin.courses.show', $course) }}" class="font-bold py-2 px-4 bg-indigo-700 text-white rounded-md">
                                Manage
                            </a>
