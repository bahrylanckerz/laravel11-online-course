    ...
    <div id="hero-section"
        ...
        <nav class="flex justify-between items-center pt-6 px-[50px]">
            ...
            <ul class="flex items-center gap-[30px] text-white">
                <li>
                    <a href="{{ route('home.index') }}" class="font-semibold">Home</a>
                </li>
                <li>
                    <a href="{{ route('home.pricing') }}" class="font-semibold">Pricing</a>
                </li>
                <li>
    ...
    <section id="video-content" class="max-w-[1100px] w-full mx-auto mt-[130px]">
        <div class="video-player relative flex flex-nowrap gap-5">
            <div class="plyr__video-embed w-full overflow-hidden relative rounded-[20px]" id="player">
                <iframe
                    src="https://www.youtube.com/embed/{{ $courseVideo->path_video }}?origin=https://plyr.io&amp;iv_load_policy=3&amp;modestbranding=1&amp;playsinline=1&amp;showinfo=0&amp;rel=0&amp;enablejsapi=1"
            ...
            <div
                ...
                <p class="font-bold text-lg text-black">{{ $course->videos->count() }} Lessons</p>
                <div class="flex flex-col gap-3">
                    <div
                        class="group p-[12px_16px] flex items-center gap-[10px] rounded-full bg-[#E9EFF3] hover:bg-[#3525B3] transition-all duration-300">
                        ...
                        <a href="{{ route('home.details', $course) }}">
                    ...
                    @forelse ($course->videos as $video)
                        ...
                        @php
                            $currentVideo = Route::current()->parameter('courseVideo');
                        ...
                        <div
                            ...
                            <a href="{{ route('home.learning', [$course, $video]) }}">
                                <p class="font-semibold group-hover:text-white transition-all duration-300 {{ $isActive ? 'text-white' : 'text-black' }}">{{ $video->name
                                    }}</p>
                            </a>
                        </div>
                    @empty
                        <p>Data Video Course Not Available</p>
                    @endforelse
                </div>
            </div>
        </div>
