        ...
        <div class="flex flex-col gap-[30px] items-center">
            ...
            <div class="max-w-[1000px] w-full flex gap-[30px]">
                <div class="flex flex-col rounded-3xl p-8 gap-[30px] bg-white h-fit">
                    <div class="flex flex-col gap-5">
                        <div class="flex flex-col gap-4">
                            ...
                            <p class="text-[#475466] text-lg">Access to few online courses that helps you to jump started
                                your new career path</p>
                        </div>
                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <div class="flex gap-3">
                                ...
                                <p class="text-[#475466]">Unlock all course badges to enhance career profile to apply a job
                                    after completed</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex flex-col rounded-3xl p-8 gap-[30px] bg-white h-fit">
                    ...
                    @if (!Auth::user()->hasActiveSubscription())
                        <a href="{{ route('home.checkout') }}" class="p-[20px_32px] bg-[#FF6129] text-white rounded-full text-center font-semibold text-xl transition-all duration-300 hover:shadow-[0_10px_20px_0_#FF612980]">Subscribe Now</a>
                    @endif
                </div>
            </div>
        </div>
