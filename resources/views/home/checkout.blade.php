...
<body class="text-black font-poppins pt-10">
    <div id="checkout-section"
        ...
        <div class="flex gap-10 px-[100px] relative z-10">
            ...
            <form action="{{ route('home.checkout.store') }}" method="POST" enctype="multipart/form-data" class="w-full flex flex-col bg-white rounded-2xl p-5 gap-5">
                @csrf
                ...
                <div class="relative">
                    ...
                    <input id="proof" type="file" name="proof" class="hidden" onchange="updateFileName(this)">
                    @if($errors->any())
